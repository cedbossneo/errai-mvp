...
public class PlaceManagerImpl implements PlaceManager,
  ...
  /**
   * Handles change events from {@link com.google.gwt.user.client.History}.
   */
  @Override
   ...
   * URL if the user refuses to navigate. (See {@link #onWindowClosing(com.google.gwt.user.client.Window.ClosingEvent)})
   *
