 ...
 * <p />
 * Classes inheriting from {@link org.jboss.errai.mvp.client.presenters.HandlerContainerImpl} and that participate in dependency
 * injection with Guice/GIN can use the automatic binding mechanism. See
 * {@link org.jboss.errai.mvp.client.presenters.HandlerContainerImpl#HandlerContainerImpl()} and {@link #HandlerContainerImpl(boolean)}
 * for more details.
 *
...
public class HandlerContainerImpl implements HandlerContainer {
   ...
   * If you are instantiating {@link org.jboss.errai.mvp.client.presenters.HandlerContainerImpl} with {@code new},
   ...
   * {@link #registerHandler(com.google.web.bindery.event.shared.HandlerRegistration)} will be removed
