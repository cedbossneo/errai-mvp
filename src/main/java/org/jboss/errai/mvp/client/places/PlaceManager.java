...
import org.jboss.errai.mvp.client.events.SetPlaceTitleHandler;
...
public interface PlaceManager extends HasHandlers {
  ...
  /**
   * Makes it possible to access the {@link com.google.web.bindery.event.shared.EventBus} object associated with that presenter.
   *
  ...
  /**
   * Checks if the {@link org.jboss.errai.mvp.client.places.PlaceManager} has to perform any pending navigation that were not
