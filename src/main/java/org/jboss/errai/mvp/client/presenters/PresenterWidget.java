...
import org.jboss.errai.mvp.client.views.PopupViewCloseHandler;
 ...
 * <p />
 * Choosing between a {@link Presenter} and {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} is a design decision that
 * requires some thought. For example, a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} is useful when
 ...
 * a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}. The drawback of a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} is that it is managed by its
 ...
 * <p />
 * {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}s and {@link Presenter}s are organized in a hierarchy.
 * Internally, parent presenters have links to their currently attached children presenters. A
 * parent {@link Presenter} can contain either {@link Presenter}s or {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}s,
 * but a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} can only contain {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}s.
 * <p />
 * To reveal a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} you should insert it within a {@link HasSlots slot} of its
 * containing presenter using one of the following methods:
 * <ul>
 * <li>{@link #setInSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget)}
 * <li>{@link #setInSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget, boolean)}
 * <li>{@link #addToSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget)}
 * <li>{@link #addToPopupSlot(org.jboss.errai.mvp.client.presenters.PresenterWidget)}
 * <li>{@link #addToPopupSlot(org.jboss.errai.mvp.client.presenters.PresenterWidget, boolean)}
 * </ul>
 * Revealing a {@link Presenter} is done differently, refer to the class documentation for more details.
 * <p />
 * To hide a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} or a {@link Presenter} you can use {@link #setInSlot} to place
 * another presenter in the same slot, or you can call one of the following methods:
 * <ul>
 * <li>{@link #removeFromSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget)}
 ...
 * <li>{@link #onUnbind()}
 * </ul>
 * Revealing or hiding a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} triggers an internal chain of events that result in
 * these lifecycle methods being called. For an example, here is what happens following
 * a call to {@link #setInSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget)}:
 * <ul>
 ...
 *         {@link org.jboss.errai.mvp.client.events.RevealContentEvent RevealContentEvent}.
 ...
 *     chain stops. Otherwise, {@link #onReveal()} is called on the {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} that
 *     was just added.</li>
 * <li>{@link #onReveal()} is called recursively on that presenter's children
 *     (top-down: first the parent, then the children).</li>
 * <li>If {@link #setInSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget, boolean)} was called with {@code false}
...
public abstract class PresenterWidget<V extends View> extends
   ...
   * every slot managed by this {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}. A slot is identified by an
   ...
   * {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}. A slot is identified by an opaque object. A
  ...
  /**
   * Creates a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} that is not necessarily using automatic
  ...
  /**
   * Creates a {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} that uses automatic binding. This will
   ...
   * you override. Also, do not call directly, see {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}
   ...
   * to perform a reset manually. See {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} for more details on
   * lifecycle methods.
   * <p />
   ...
   * {@link #addToSlot(Object, org.jboss.errai.mvp.client.presenters.PresenterWidget)}, {@link #addToPopupSlot(org.jboss.errai.mvp.client.presenters.PresenterWidget)}
   ...
   * See {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} for ways to hide a presenter.
   */
  void internalHide() {
   ...
   * See {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} and {@link Presenter} for ways to reveal a
   * presenter.
   */
  void internalReveal() {
   ...
   * to a new parent.
   *
   * @param newParent The new parent {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}.
   */
  ...
  /**
   * Called by a child {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} when it wants to detach itself
   * from this parent.
   *
   * @param childPresenter The {@link org.jboss.errai.mvp.client.presenters.PresenterWidget}. It should be a child of this presenter.
   */
   ...
   * future messages.
   *
   * @param popupPresenter The {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} to monitor.
   */
   ...
   *
   * @param content The {@link org.jboss.errai.mvp.client.presenters.PresenterWidget} added as a popup which we want to remove.
   */
