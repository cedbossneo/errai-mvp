...
public class PlaceRequest {
   ...
   * {@link Proxy#reveal(org.jboss.errai.mvp.client.places.PlaceRequest)}. You can later add parameters by doing:
   *
   * <pre>
   ...
   *
   * @param req The {@link org.jboss.errai.mvp.client.places.PlaceRequest} to copy.
  ...
  /**
   * Extracts a given parameter from the {@link org.jboss.errai.mvp.client.places.PlaceRequest}.
   *
   ...
   *
   * @param other The {@link org.jboss.errai.mvp.client.places.PlaceRequest} to check against.
